...
extract_offsets_script = "extract_offsets.py"  # Замените на фактический путь к скрипту
...
def split(args):
    ...
    if args.extract:
        ...
        print ("")
        print(f"Extracted {len(positions)} appended dts and dtb to folder /dtb and you can edit dts")
    else:
